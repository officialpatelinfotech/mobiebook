...
@Component({
  selector: 'app-manage-photographer',
  templateUrl: './manage-photographer.component.html',
  styleUrls: ['./manage-photographer.component.css']
})
export class ManagePhotographerComponent implements OnInit, OnDestroy {
  userList: any[] = [];
  ...
  getUserList(): void {
    this.pagination.BusinessTypeId = BusinessType.PhotoGrapher;
