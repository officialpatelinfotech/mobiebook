...
@Component({
  selector: 'app-manage-buy-coupon',
  templateUrl: './manage-buy-coupon.component.html',
  styleUrls: ['./manage-buy-coupon.component.css']
})
export class ManageBuyCouponComponent implements OnInit {
  couponDetail: any[] = [];
  customerCoupon:any;
  ...
  getRequestedCoupon(){
    ...
    this.couponService.customerRequestedCoupon(detail)
        .subscribe((data: any) => {
